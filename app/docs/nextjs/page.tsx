...
Public endpoints only return published posts; status=draft and status=all return 400. Read drafts or write content through /api/v1/blogs/{blogId} with a scoped API key, documented at /docs/api/management. Never expose private keys in NEXT_PUBLIC_* variables. List responses are paginated: iterate all pages when building a complete archive.
