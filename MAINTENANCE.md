...
- Corregida la caché de categorías: 60 s y etiqueta por blog invalidada al crear, editar o borrar categorías. Editar/borrar también invalida las publicaciones, que incluyen nombres y slugs de categorías. Se observó en producción una lista de categorías vacía mientras una publicación ya devolvía la categoría `notes`.
